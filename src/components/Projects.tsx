...
function ProjectCard({
  ...
  // Tilt (degrees) + spotlight position (px within the card).
  ...
  const handleMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    rotateY.set((px - 0.5) * 8); // left/right tilt
  ...
  const spotlight = useMotionTemplate`radial-gradient(420px circle at ${spotX}% ${spotY}%, ${project.colorLight}, transparent 60%)`;
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: hovered ? project.colorLight : '#111111',
        borderColor: hovered ? project.borderColor : '#1f1f1f',
      }}
      className="relative rounded-2xl border transition-colors duration-300 overflow-hidden cursor-pointer group will-change-transform"
    >
      {/* Cursor spotlight */}
      <motion.div
        aria-hidden
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16">
          ...
          >
            ...
            <span className="glow-text">
              <ScrambleText text="Latest Projects" duration={1000} />
            </span>
          </motion.h2>
